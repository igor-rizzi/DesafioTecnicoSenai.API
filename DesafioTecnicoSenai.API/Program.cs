using DesafioTecnicoSenai.API.Configuration;
...
using (var scope = app.Services.CreateScope())
{
    ...
    var db = scope.ServiceProvider.GetRequiredService<DesafioTecnicoSenaiDbContext>();
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        ...
        c.RoutePrefix = string.Empty; // para abrir direto em localhost:porta/
    });
}
